...
import { SmartGoalAssistant } from "@/components/ai/smart-goal-assistant"
    ...
    <div className="mx-auto max-w-2xl">
      <Card className="border-t-4 border-t-blue-500">
        <CardHeader>
          ...
          <CardDescription>Set a new SMART goal for your professional development</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
      ...
      <SmartGoalAssistant
        category={form.watch("category") || "Technical"}
        onApplySuggestion={(suggestion) => {
          form.setValue("title", suggestion.title)
          form.setValue("description", suggestion.description)
          form.setValue("category", suggestion.category)
          form.setValue("status", suggestion.status)
        }}
      />
    </div>
  )
